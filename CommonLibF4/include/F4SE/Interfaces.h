...
class QueryInterface
{
  ...
  public:
    [[nodiscard]] REL::Version EditorVersion() const noexcept
    {
        return MakeVersion(GetProxy().editorVersion);
    }
    [[nodiscard]] REL::Version F4SEVersion() const noexcept
    {
        return MakeVersion(GetProxy().f4seVersion);
    }
    ...
    {
        return GetProxy().isEditor != 0;
    }
    [[nodiscard]] REL::Version RuntimeVersion() const noexcept
    {
        return MakeVersion(GetProxy().runtimeVersion);
    }
};
...
class MessagingInterface
{
  ...
  public:
    ...
    bool RegisterListener(EventCallback *a_handler) const
    {
        return RegisterListener(a_handler, "F4SE"sv);
    }
...
class TaskInterface
{
  ...
  public:
    ...
    void AddTask(std::function<void()> a_task) const
    {
    ...
    void AddUITask(std::function<void()> a_task) const
    {
...
class ObjectInterface
{
  ...
  public:
    ...
    [[nodiscard]] DelayFunctorManager &GetDelayFunctorManager() const
    {
    ...
    [[nodiscard]] PersistentObjectStorage &GetPersistentObjectStorage() const
    {
