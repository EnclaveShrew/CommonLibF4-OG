...
struct string
{
    ...
    [[nodiscard]] consteval const_pointer data() const noexcept
    {
        return c;
    }
    ...
    [[nodiscard]] consteval size_type length() const noexcept
    {
        return N;
    }
...
template <class F>
class counted_function_iterator : public boost::stl_interfaces::iterator_interface<
