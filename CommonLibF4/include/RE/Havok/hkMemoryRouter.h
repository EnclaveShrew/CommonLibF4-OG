...
class hkMemoryRouter
{
  public:
    ...
    void SetDebug(Allocator *a_val) noexcept
    {
        debug = a_val;
    }
    void SetHeap(Allocator *a_val) noexcept
    {
        heap = a_val;
    }
    void SetSolver(Allocator *a_val) noexcept
    {
        solver = a_val;
    }
    void SetTemp(Allocator *a_val) noexcept
    {
        temp = a_val;
    }
    [[nodiscard]] Stack &GetStack() noexcept
    {
        return stack;
    }
