...
namespace RE
{
class __declspec(novtable) hkLifoAllocator : public hkMemoryAllocator // 00
{
  public:
    ...
    void GetMemoryStatistics(
        [[maybe_unused]] MemoryStatistics &a_stats) const override
    {
        return;
    } // 08
    std::int32_t GetAllocatedSize(
        [[maybe_unused]] const void *a_obj,
        std::int32_t a_numBytes) const override
    {
        return a_numBytes;
    } // 09
