  ...
  public:
    ...
    class __declspec(novtable) KeyInterface
    {
      public:
        ...
        virtual const char *GetFileURL(KeyHandle) const
        {
            return nullptr;
        } // 06
    };
...
class __declspec(novtable) ResourceLibBase : public RefCountBase<ResourceLibBase, 2> // 00
{
  public:
    // add
...
class __declspec(novtable) Resource : public NewOverrideBase<2> // 00
{
  public:
