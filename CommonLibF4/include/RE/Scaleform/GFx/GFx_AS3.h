...
class ClassTable : public NewOverrideBase<338>
{
  public:
    // members
...
class ConstPool : public NewOverrideBase<339>
{
  public:
    // members
...
class MethodBodyTable : public NewOverrideBase<338>
{
  public:
    // members
...
class MethodTable : public NewOverrideBase<338>
{
  public:
    // members
    std::byte pad[0x18]; // 00
...
class MetadataTable : public NewOverrideBase<338>
{
  public:
    // members
    std::byte pad[0x18]; // 00
...
class ScriptTable : public NewOverrideBase<338>
{
  public:
    // members
    std::byte pad[0x18]; // 00
...
class TraitTable : public NewOverrideBase<338>
{
  public:
    // members
    std::byte pad[0x18]; // 00
...
class __declspec(novtable) alignas(0x10) File : public RefCountImpl, // 00
...
class __declspec(novtable) RefCountBaseGC : public NewOverrideBase<STAT> // 00
{
  public:
...
class __declspec(novtable) GASRefCountBase : public RefCountBaseGC<328> // 00
{
  public:
};
...
class __declspec(novtable) CallFrame : public Scaleform::NewOverrideBase<330>
{
  public:
    // members
...
class __declspec(novtable) MovieRoot : public Scaleform::GFx::ASMovieRootBase,         // 00
...
class StringManager : public ASStringBuiltinManagerT<BuiltinType, 65>
{
  public:
};
...
class __declspec(novtable) VM : public Scaleform::NewOverrideBase<329>
{
  public:
    enum ErrorID
    {
...
class __declspec(novtable) ASVM : public VM // 00
{
  public:
    // members
...
class __declspec(novtable) VMFile : public GASRefCountBase
{
  public:
    // members
    VM *vmRef;                    // 28
...
class __declspec(novtable) VMAbcFile : public VMFile
{
  public:
    // members
