...
class __declspec(novtable) State : public RefCountBase<State, 2> // 00
{
  public:
    ...
    [[nodiscard]] constexpr StateType GetStateType() const noexcept
    {
        return *sType;
    }
...
class __declspec(novtable) ActionControl : public State // 00
{
  public:
...
class __declspec(novtable) Translator : public State
{
  public:
    // members
...
class __declspec(novtable) StateBag : public FileTypeConstants // 00
{
  protected:
    // add
...
class __declspec(novtable) Loader : public StateBag // 00
{
  public:
...
class System : public Scaleform::System // 0
{
  public:
};
