...
class __declspec(novtable) ASMovieRootBase : public RefCountBase<ASMovieRootBase, 327> // 00
{
  public:
    // add
    ...
    virtual void GenerateTouchEvents([[maybe_unused]] std::uint32_t a_mouseStateIndex)
    {
        return;
    } // 0E
    ...
    virtual void NotifyGamePadAnalogEvent([[maybe_unused]] const EventId *a_id)
    {
        return;
    } // 17
    virtual void NotifyStatusEvent([[maybe_unused]] const EventId *a_id)
    {
        return;
    } // 18
    virtual void NotifyAccelerometerEvent([[maybe_unused]] const EventId *a_id, [[maybe_unused]] std::int32_t a_evtIDAcc)
    {
        return;
    } // 19
    ...
    virtual void OnAppLifecycleEvent([[maybe_unused]] const AppLifecycleEvent &)
    {
        return;
    } // 1E
    virtual void OnAccelerometerEvent([[maybe_unused]] const AccelerometerEvent &)
    {
        return;
    } // 1F
    virtual void OnGeolocationEvent([[maybe_unused]] const GeolocationEvent &)
    {
        return;
    } // 20
    virtual void PrintObjectsReport([[maybe_unused]] std::uint32_t a_flags = 0, [[maybe_unused]] Log *a_log = nullptr, [[maybe_unused]] const char *a_swfName = nullptr)
    {
        return;
    } // 21
    virtual void GetObjectsTree([[maybe_unused]] Array<Ptr<AmpMovieObjectDesc>> *a_rootObjects, [[maybe_unused]] MemoryHeap *a_heap)
    {
        return;
    } // 22
