...
class __declspec(novtable) alignas(0x08) MemoryContext : public RefCountBase<MemoryContext, 2> // 00
{
  public:
...
class __declspec(novtable) MovieDef : public Resource, // 00
                                      public StateBag  // 18
{
  public:
    ...
    struct __declspec(novtable) ResourceVisitor : public FileTypeConstants // 00
    {
      public:
...
class Value
{
  public:
    ...
    class __declspec(novtable) ObjectInterface : public NewOverrideBase<327>
    {
      public:
...
class __declspec(novtable) alignas(0x08) FunctionHandler : public RefCountBase<FunctionHandler, 2> // 00
{
  public:
...
class __declspec(novtable) Movie : public RefCountBase<Movie, 327>, // 00
                                   public StateBag                  // 10
{
  public:
...
class __declspec(novtable) MovieImpl : public Movie // 00
{
  public:
    // members
...
class __declspec(novtable) alignas(0x08) KeyboardState : public RefCountBase<KeyboardState, 2> // 00
{
  public:
