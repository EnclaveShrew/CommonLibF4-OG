...
class __declspec(novtable) ContextLock : public RefCountBase<ContextLock, 69> // 00
{
  public:
    // members
    Lock lockObject;  // 10
...
class RTHandle
{
  public:
    ...
    struct __declspec(novtable) HandleData : public RefCountBase<HandleData, 69>, // 00
...
template <class C>
class DisplayHandle : public RTHandle // 0
{
  public:
};
...
{
  public:
    struct PropagateNode : public ListNode<PropagateNode> // 00
    {
      public:
    };
...
{
  public:
    struct ContextNode : public ListNode<ContextNode> // 00
    {
      public:
        // members
        Context *context; // 10
    ...
    class __declspec(novtable) ServiceCommand : public ThreadCommand // 00
    {
      public:
...
class __declspec(novtable) ContextCaptureNotify : public ListNode<ContextCaptureNotify> // 00
{
  public:
    ...
    virtual void OnNextCapture([[maybe_unused]] RenderNotify *a_notify)
    {
    } // 02
    virtual void OnShutdown([[maybe_unused]] bool a_waitFlag)
    {
    } // 03
...
struct EntryPageBase : public ListNode<EntryPageBase> // 00
{
  public:
    // members
...
struct EntryPage : public EntryPageBase // 000
{
  public:
    // members
...
struct SnapshotPage : public ListNode<SnapshotPage> // 000
{
  public:
    // members
