...
class __declspec(novtable) SysAlloc : public SysAllocBase // 0
{
  public:
...
class __declspec(novtable) SysAllocPaged : public SysAllocBase // 0
{
  public:
    ...
    virtual void VisitMem([[maybe_unused]] Heap::MemVisitor *a_visitor) const
    {
        return;
    } // 0D
    virtual void VisitSegments(
        ...
        [[maybe_unused]] std::size_t a_catUnused) const
    {
        return;
    } // 0E
};
