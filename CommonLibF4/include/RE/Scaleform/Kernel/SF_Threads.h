...
class __declspec(novtable) Waitable : public RefCountBase<Waitable, 2> // 00
{
  public:
    ...
    struct HandlerArray : public NewOverrideBase<2> // 00
    {
...
class __declspec(novtable) Mutex : public Waitable,        // 00
...
class __declspec(novtable) Event : public Waitable,        // 00
                                   public AcquireInterface // 18
{
  public:
    // members
