...
class RefCountImpl : public RefCountImplCore // 00
{
  public:
...
class RefCountBaseStatImpl : public Base // 00
{
  public:
...
class RefCountBase : public RefCountBaseStatImpl<RefCountImpl, STAT> // 00
{
  public:
