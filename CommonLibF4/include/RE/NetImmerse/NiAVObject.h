...
class __declspec(novtable) NiAVObject : public NiObjectNET // 000
{
  public:
    ...
    virtual void AttachProperty([[maybe_unused]] NiAlphaProperty *a_prop)
    {
        return;
    } // 2A
    ...
    [[nodiscard]] bool GetAppCulled() const noexcept
    {
        return flags.flags & 1;
    }
    [[nodiscard]] std::uint64_t GetFlags() const noexcept
    {
        return flags.flags;
    }
    [[nodiscard]] bool ShadowCaster() const noexcept
    {
        return ~(flags.flags >> 40) & 1;
    }
