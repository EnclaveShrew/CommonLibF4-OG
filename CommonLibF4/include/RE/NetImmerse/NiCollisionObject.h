...
class __declspec(novtable) NiCollisionObject : public NiObject // 00
{
  public:
    ...
    virtual void Initialize([[maybe_unused]] void *a_data)
    {
        return;
    } // 2A
    virtual void Convert([[maybe_unused]] std::uint32_t a_version, [[maybe_unused]] void *a_data)
    {
        return;
    } // 2B
