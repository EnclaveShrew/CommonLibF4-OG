...
class __declspec(novtable) NiObject : public NiRefObject // 00
{
  public:
    ...
    virtual NiParticleSystem *IsParticleSystem()
    {
        return nullptr;
    } // 12
    ...
    virtual NiObject *CreateClone([[maybe_unused]] NiCloningProcess &a_cloneData)
    {
        return nullptr;
    } // 1A
