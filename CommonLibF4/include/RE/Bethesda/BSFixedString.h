...
class BSFixedString
{
  ...
  protected:
    ...
    [[nodiscard]] const void *hash_accessor() const noexcept
    {
        return _data;
    }
...
class BGSLocalizedString
{
  ...
  protected:
    ...
    [[nodiscard]] const BSFixedStringCS &hash_accessor() const noexcept
    {
        return _data;
    }
...
struct BGSLocalizedStrings
{
    struct ScrapStringBuffer
    {
      public:
        ...
        {
            return static_cast<const char *>(buffer.GetPtr()) + offset;
        }
