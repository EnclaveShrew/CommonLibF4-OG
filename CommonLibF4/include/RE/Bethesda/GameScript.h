...
class __declspec(novtable) DelayFunctor : public BSIntrusiveRefCounted // 08
{
  public:
...
class __declspec(novtable) Logger : public BSScript::ErrorLogger // 00
{
  public:
...
struct __declspec(novtable) HandlePolicy : public BSScript::IObjectHandlePolicy // 00
{
  public:
...
class __declspec(novtable) ObjectBindPolicy : public BSScript::ObjectBindPolicy // 00
{
  public:
    ...
    std::uint32_t GetExtraInfoSize(std::size_t) const override
    {
        return 0;
    } // 08
...
{
  public:
    class Fragment : public BSIntrusiveRefCounted // 00
    {
      public:
        // members
    ...
    class QuestStageFragments : public BSIntrusiveRefCounted // 00
    {
      public:
        // members
    ...
    struct QuestFragments : public BSIntrusiveRefCounted // 00
    {
      public:
        // members
    ...
    class BeginEndFragments : public BSIntrusiveRefCounted // 00
    {
      public:
        // members
    ...
    class SceneFragments : public BSIntrusiveRefCounted // 00
    {
      public:
        // members
        BSTSmartPointer<Fragment> beginFragment;                                      // 08
    ...
    class PackageFragments : public BSIntrusiveRefCounted // 00
    {
      public:
        // members
        BSTSmartPointer<Fragment> beginFragment;  // 08
    ...
    class PerkFragments : public BSIntrusiveRefCounted // 00
    {
      public:
        // members
    ...
    class TerminalFragments : public BSIntrusiveRefCounted // 00
    {
      public:
        // members
...
class __declspec(novtable) Profiler : public BSScript::IProfilePolicy // 000
{
  public:
...
class __declspec(novtable) SavePatcher : public BSScript::ISavePatcherInterface // 0
{
  public:
    ...
    void PatchStackFrame(BSScript::StackFrame &, BSScript::IVirtualMachine &) override
    {
        return;
    } // 01
};
...
class __declspec(novtable) GameVM : public BSScript::IClientVM,                          // 0000
                                    ...
                                    public BSTEventSource<GameScript::StatsEvent>        // 0058
{
  public:
    ...
    [[nodiscard]] BSTSmartPointer<BSScript::IVirtualMachine> GetVM() const noexcept
    {
        return impl;
    }
...
namespace GameScript
{
class __declspec(novtable) BasicEventHandler : public BSTEventSink<BGSLocationLoadedEvent>,                        // 000
...
class __declspec(novtable) CombatEventHandler : public BSTEventSink<TESHitEvent>,              // 00
...
class RefrOrInventoryObj
{
  public:
    ...
    [[nodiscard]] TESObjectREFR *Container() const noexcept
    {
        return _container;
    }
    [[nodiscard]] TESObjectREFR *Reference() const noexcept
    {
        return _ref;
    }
    [[nodiscard]] std::uint16_t UniqueID() const noexcept
    {
        return _uniqueID;
    }
...
class __declspec(novtable) BaseHandleReaderWriter : public RE::BSScript::IHandleReaderWriter
{
  public:
