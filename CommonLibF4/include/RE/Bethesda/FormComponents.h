...
class __declspec(novtable) ActorValueOwner
{
  public:
    ...
    // add
    virtual float GetActorValue([[maybe_unused]] const ActorValueInfo &a_info) const
    {
        return 0.0F;
    } // 01
    virtual float GetPermanentActorValue([[maybe_unused]] const ActorValueInfo &a_info) const
    {
        return 0.0F;
    } // 02																																								// 02
    virtual float GetBaseActorValue([[maybe_unused]] const ActorValueInfo &a_info) const
    {
        return 0.0F;
    } // 03
    virtual void SetBaseActorValue([[maybe_unused]] const ActorValueInfo &a_info, [[maybe_unused]] float a_value)
    {
        return;
    } // 04
    virtual void ModBaseActorValue([[maybe_unused]] const ActorValueInfo &a_info, [[maybe_unused]] float a_delta)
    {
        return;
    } // 05
    virtual void ModActorValue([[maybe_unused]] ACTOR_VALUE_MODIFIER a_modifier, [[maybe_unused]] const ActorValueInfo &a_info, [[maybe_unused]] float a_delta)
    {
        return;
    } // 06
    virtual float GetModifier([[maybe_unused]] ACTOR_VALUE_MODIFIER a_modifier, [[maybe_unused]] const ActorValueInfo &a_info) const
    {
        return 0.0F;
    } // 07
    virtual void RestoreActorValue([[maybe_unused]] const ActorValueInfo &a_info, [[maybe_unused]] float a_amount)
    {
        return;
    } // 08
    virtual void SetActorValue(const ActorValueInfo &a_info, float a_value)
    {
        SetBaseActorValue(a_info, a_value);
    } // 09
...
class __declspec(novtable) BGSOpenCloseForm
{
  public:
    ...
    // add
    virtual void HandleOpenStart(TESObjectREFR *, TESObjectREFR *, bool)
    {
        return;
    } // 01
    virtual void HandleCloseStart(TESObjectREFR *, TESObjectREFR *, bool)
    {
        return;
    } // 02
    virtual void HandleOpenFinish(TESObjectREFR *, TESObjectREFR *)
    {
        return;
    } // 03
    virtual void HandleCloseFinish(TESObjectREFR *, TESObjectREFR *)
    {
        return;
    } // 04
};
...
class __declspec(novtable) BSIMusicTrack
{
  public:
    ...
    virtual void DoSetDuckingAttenuation([[maybe_unused]] std::uint16_t a_ducking)
    {
        return;
    } // 09
...
class __declspec(novtable) BSIMusicType
{
  public:
    ...
    virtual void DoApplyDuckingAttenuation([[maybe_unused]] std::uint16_t a_ducking)
    {
        return;
    } // 04
    virtual void DoClearDucking()
...
class __declspec(novtable) TBO_InstanceData : public BSIntrusiveRefCounted // 08
{
  public:
    ...
    // add
    virtual BGSKeywordForm *GetKeywordData() const
    {
        return nullptr;
    } // 01
    ...
    virtual BGSBlockBashData *GetBlockBashData() const
    {
        return nullptr;
    } // 04
    ...
    virtual BSTArray<EnchantmentItem *> *GetEnchantmentArray() const
    {
        return nullptr;
    } // 07
    ...
    virtual BSTArray<BGSMaterialSwap *> *GetMaterialSwapArray() const
    {
        return nullptr;
    } // 0A
    ...
    virtual std::uint32_t GetHealth() const
    {
        return 0;
    } // 0F
...
class __declspec(novtable) BaseFormComponent
{
  public:
    ...
    virtual void CopyComponent([[maybe_unused]] BaseFormComponent *a_copy)
    {
        return;
    } // 06
    virtual void CopyComponent([[maybe_unused]] BaseFormComponent *a_copy, [[maybe_unused]] TESForm *a_owner)
    {
        return;
    } // 05
};
...
class __declspec(novtable) TESTexture : public BaseFormComponent // 00
{
  public:
...
class __declspec(novtable) TESIcon : public TESTexture // 00
{
  public:
...
class __declspec(novtable) BGSAttachParentArray : public BaseFormComponent,                                   // 00
...
class __declspec(novtable) BGSAttackData : public NiRefObject // 00
{
  public:
...
class __declspec(novtable) BGSAttackDataMap : public NiRefObject // 00
{
  public:
...
class __declspec(novtable) BGSAttackDataForm : public BaseFormComponent // 00
{
  public:
...
class __declspec(novtable) BGSBipedObjectForm : public BaseFormComponent // 00
{
  public:
    static constexpr auto RTTI{RTTI::BGSBipedObjectForm};
    static constexpr auto VTABLE{VTABLE::BGSBipedObjectForm};

    [[nodiscard]] std::uint32_t GetFilledSlots() const noexcept
    {
...
class __declspec(novtable) BGSBlockBashData : public BaseFormComponent // 00
{
  public:
...
class __declspec(novtable) BGSCraftingUseSound : public BaseFormComponent // 00
{
  public:
...
class __declspec(novtable) BGSDestructibleObjectForm : public BaseFormComponent // 00
{
  public:
...
class __declspec(novtable) BGSEquipType : public BaseFormComponent // 00
{
  public:
    ...
    // add
    [[nodiscard]] virtual BGSEquipSlot *GetEquipSlot([[maybe_unused]] const TBO_InstanceData *a_data) const
    {
        return equipSlot;
    } // 06
...
class __declspec(novtable) BGSFeaturedItemMessage : public BaseFormComponent // 00
{
  public:
...
class __declspec(novtable) BGSForcedLocRefType : public BaseFormComponent // 00
{
  public:
...
class __declspec(novtable) BGSIdleCollection : public BaseFormComponent // 00
{
  public:
...
class __declspec(novtable) BGSInstanceNamingRulesForm : public BaseFormComponent // 00
{
  public:
...
class __declspec(novtable) BGSKeywordForm : public BaseFormComponent, // 00
...
class __declspec(novtable) BGSMenuDisplayObject : public BaseFormComponent // 00
{
  public:
...
class __declspec(novtable) BGSMessageIcon : public BaseFormComponent // 00
{
  public:
    ...
    [[nodiscard]] const BSFixedString &GetMessageIconTextureName() const noexcept
    {
        return icon.textureName;
    }
    void SetMessageIconTextureName(BSFixedString a_texture)
    {
        icon.textureName = std::move(a_texture);
    }
...
class __declspec(novtable) BGSNativeTerminalForm : public BaseFormComponent // 00
{
  public:
...
class __declspec(novtable) BGSOverridePackCollection : public BaseFormComponent // 00
{
  public:
...
class __declspec(novtable) BGSPerkRankArray : public BaseFormComponent // 00
{
  public:
...
class __declspec(novtable) BGSPickupPutdownSounds : public BaseFormComponent // 00
{
  public:
...
class __declspec(novtable) BGSPreloadable : public BaseFormComponent // 00
{
  public:
...
class __declspec(novtable) BGSPreviewTransform : public BaseFormComponent // 00
{
  public:
...
class __declspec(novtable) BGSPropertySheet : public BaseFormComponent // 00
{
  public:
...
class __declspec(novtable) BGSSkinForm : public BaseFormComponent // 00
{
  public:
...
class __declspec(novtable) BGSSoundTagComponent : public BaseFormComponent // 0
{
  public:
...
class __declspec(novtable) TESContainer : public BaseFormComponent // 00
{
  public:
...
class __declspec(novtable) TESDescription : public BaseFormComponent // 00
{
  public:
...
class __declspec(novtable) TESEnchantableForm : public BaseFormComponent // 00
{
  public:
    ...
    [[nodiscard]] std::uint16_t GetBaseCharge() const noexcept
    {
        return amountOfEnchantment;
    }
    [[nodiscard]] EnchantmentItem *GetBaseEnchanting() const noexcept
    {
        return formEnchanting;
    }
    void SetBaseCharge(std::uint16_t a_amount) noexcept
    {
        amountOfEnchantment = a_amount;
    }
    void SetBaseEnchanting(EnchantmentItem *a_ench) noexcept
    {
        formEnchanting = a_ench;
    }
...
class __declspec(novtable) TESFullName : public BaseFormComponent // 00
{
  public:
...
class __declspec(novtable) TESHealthForm : public BaseFormComponent // 00
{
  public:
...
class __declspec(novtable) TESModel : public BaseFormComponent // 00
{
  public:
    ...
    virtual BGSModelMaterialSwap *GetAsModelMaterialSwap()
    {
        return nullptr;
    } // 09
...
class __declspec(novtable) BGSBehaviorGraphModel : public TESModel // 00
{
  public:
...
class __declspec(novtable) BGSModelMaterialSwap : public TESModel // 00
{
  public:
...
class __declspec(novtable) BGSTextureModel : public TESModel // 00
{
  public:
...
class __declspec(novtable) TESModelRDT : public TESModel // 00
{
  public:
...
class __declspec(novtable) TESActorBaseData : public BaseFormComponent // 00
{
  public:
    ...
    [[nodiscard]] constexpr bool AffectsStealthMeter() const noexcept
    {
        return actorData.actorBaseFlags.none(ACTOR_BASE_DATA::Flag::kDoesntAffectStealthMeter);
    }
    [[nodiscard]] constexpr bool Bleeds() const noexcept
    {
        return actorData.actorBaseFlags.none(ACTOR_BASE_DATA::Flag::kDoesntBleed);
    }
    [[nodiscard]] constexpr bool IsEssential() const noexcept
    {
        return actorData.actorBaseFlags.all(ACTOR_BASE_DATA::Flag::kEssential);
    }
    [[nodiscard]] constexpr bool IsFemale() const noexcept
    {
        return actorData.actorBaseFlags.all(ACTOR_BASE_DATA::Flag::kFemale);
    }
    [[nodiscard]] inline bool IsGhost() const
    {
        return GetIsGhost();
    }
    [[nodiscard]] constexpr bool IsPreset() const noexcept
    {
        return actorData.actorBaseFlags.all(ACTOR_BASE_DATA::Flag::kIsChargenFacePreset);
    }
    [[nodiscard]] constexpr bool IsProtected() const noexcept
    {
        return actorData.actorBaseFlags.all(ACTOR_BASE_DATA::Flag::kProtected);
    }
    [[nodiscard]] constexpr bool IsSimpleActor() const noexcept
    {
        return actorData.actorBaseFlags.all(ACTOR_BASE_DATA::Flag::kSimpleActor);
    }
    [[nodiscard]] constexpr bool IsSummonable() const noexcept
    {
        return actorData.actorBaseFlags.all(ACTOR_BASE_DATA::Flag::kSummonable);
    }
    [[nodiscard]] constexpr bool IsUnique() const noexcept
    {
        return actorData.actorBaseFlags.all(ACTOR_BASE_DATA::Flag::kUnique);
    }
    [[nodiscard]] inline bool IsInvulnerable() const
    {
        return GetInvulnerable();
    }
    [[nodiscard]] constexpr bool HasAutoCalcStats() const noexcept
    {
        return actorData.actorBaseFlags.all(ACTOR_BASE_DATA::Flag::kAutoCalcStats);
    }
    [[nodiscard]] constexpr bool HasBleedoutOverride() const noexcept
    {
        return actorData.actorBaseFlags.all(ACTOR_BASE_DATA::Flag::kBleedoutOverride);
    }
    [[nodiscard]] constexpr bool HasPCLevelMult() const noexcept
    {
        return actorData.actorBaseFlags.all(ACTOR_BASE_DATA::Flag::kPCLevelMult);
    }
    [[nodiscard]] constexpr bool Respawns() const noexcept
    {
        return actorData.actorBaseFlags.all(ACTOR_BASE_DATA::Flag::kRespawn);
    }
    [[nodiscard]] constexpr bool UsesOppositeGenderAnims() const noexcept
    {
        return actorData.actorBaseFlags.all(ACTOR_BASE_DATA::Flag::kOppositeGenderanims);
    }
    [[nodiscard]] constexpr bool UsesTemplate() const noexcept
    {
        return actorData.actorBaseFlags.all(ACTOR_BASE_DATA::Flag::kUsesTemplate);
    }
...
class __declspec(novtable) TESAIForm : public BaseFormComponent // 00
{
  public:
...
class __declspec(novtable) TESBipedModelForm : public BaseFormComponent // 000
{
  public:
...
class __declspec(novtable) TESImageSpaceModifiableForm : public BaseFormComponent // 00
{
  public:
...
class __declspec(novtable) TESLeveledList : public BaseFormComponent // 00
{
  public:
    ...
    virtual std::int32_t GetMaxLevelDifference()
    {
        return 0;
    } // 09
...
class __declspec(novtable) TESModelTri : public TESModel // 00
{
  public:
...
class __declspec(novtable) TESProduceForm : public BaseFormComponent // 00
{
  public:
...
class __declspec(novtable) TESRaceForm : public BaseFormComponent // 00
{
  public:
    ...
    [[nodiscard]] TESRace *GetFormRace() const noexcept
    {
        return formRace;
    }
    void SetFormRace(TESRace *a_race) noexcept
    {
        formRace = a_race;
    }
...
class __declspec(novtable) TESReactionForm : public BaseFormComponent // 00
{
  public:
...
struct __declspec(novtable) TESRegionList : public BSSimpleList<TESRegion *>
{
  public:
...
class __declspec(novtable) TESSpellList : public BaseFormComponent // 00
{
  public:
...
class __declspec(novtable) TESTexture1024 : public TESTexture // 10
{
  public:
...
class __declspec(novtable) TESValueForm : public BaseFormComponent // 00
{
  public:
    ...
    [[nodiscard]] std::int32_t GetFormValue() const noexcept
    {
        return value;
    }
...
class __declspec(novtable) TESWeightForm : public BaseFormComponent // 00
{
  public:
    ...
    [[nodiscard]] float GetFormWeight() const noexcept
    {
        return weight;
    }
    void SetFormWeight(float a_weight) noexcept
    {
        weight = a_weight;
    }
