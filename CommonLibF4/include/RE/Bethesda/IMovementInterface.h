...
struct __declspec(novtable) IMovementState : public IMovementInterface // 0
{
  public:
...
struct PlayerControlsMovementData : public MovementData // 00
{
  public:
    // members
...
struct __declspec(novtable) IMovementPlayerControls : public IMovementInterface // 00
{
  public:
...
class __declspec(novtable) IMovementPlayerControlsFilter : public IMovementInterface // 00
{
  public:
