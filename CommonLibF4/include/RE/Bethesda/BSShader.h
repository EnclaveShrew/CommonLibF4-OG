...
class __declspec(novtable) BSShader : public NiRefObject,    // 000
                                      public BSReloadShaderI // 010
{
  public:
    ...
    virtual void SetupMaterial([[maybe_unused]] const BSShaderMaterial *a_material)
    {
        return;
    } // 04
    virtual void RestoreMaterial([[maybe_unused]] const BSShaderMaterial *a_material)
    {
        return;
    } // 05
...
class __declspec(novtable) BSUtilityShader : public BSShader // 000
{
  public:
