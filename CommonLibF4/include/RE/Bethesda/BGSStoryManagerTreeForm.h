...
class __declspec(novtable) BGSStoryManagerTreeForm : public TESForm // 00
{
  public:
...
class __declspec(novtable) TESQuest : public BGSStoryManagerTreeForm, // 000
...
class __declspec(novtable) BGSStoryManagerNodeBase : public BGSStoryManagerTreeForm // 00
{
  public:
...
class __declspec(novtable) BGSStoryManagerBranchNode : public BGSStoryManagerNodeBase // 00
{
  public:
...
class __declspec(novtable) BGSStoryManagerQuestNode : public BGSStoryManagerNodeBase // 00
{
  public:
...
class __declspec(novtable) BGSStoryManagerEventNode : public BGSStoryManagerBranchNode // 00
{
  public:
