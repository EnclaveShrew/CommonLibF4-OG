...
class __declspec(novtable) bhkNPCollisionObjectBase : public NiCollisionObject // 00
{
  public:
...
class __declspec(novtable) bhkNPCollisionObject : public bhkNPCollisionObjectBase // 00
{
  public:
...
class __declspec(novtable) bhkNPCollisionObjectUnlinked : public bhkNPCollisionObject // 00
{
  public:
...
class __declspec(novtable) bhkCharacterController : public bhkNPCollisionObjectUnlinked,                // 000
