...
class __declspec(novtable) BSAwardsSystemUtility
{
  public:
    ...
    virtual void DoClearAward([[maybe_unused]] std::int32_t a_id)
    {
        return;
    } // 02
    ...
    virtual void DoUnlockAward([[maybe_unused]] std::int32_t a_id)
    {
        return;
    } // 05
    virtual bool DoGetUltimateAwardEarned() const
    {
        return false;
    } // 06
};
