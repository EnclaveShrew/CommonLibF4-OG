...
class __declspec(novtable) BSHandleRefObject : public NiRefObject // 00
{
  public:
...
class __declspec(novtable) IAnimationGraphManagerHolder
{
  public:
    ...
    virtual bool CreateAnimationChannels([[maybe_unused]] BSScrapArray<BSTSmartPointer<BSAnimationGraphChannel>> &a_channels)
    {
        return false;
    } // 0B
    virtual void PostCreateAnimationGraphManager([[maybe_unused]] BSTSmartPointer<BSAnimationGraphManager> &a_animGraphMgr)
    {
        return;
    } // 0C
    virtual void PostChangeAnimationManager([[maybe_unused]] const BSTSmartPointer<BSAnimationGraphManager> &a_newAnimGraphMgr, [[maybe_unused]] const BSTSmartPointer<BSAnimationGraphManager> &a_oldAnimGraphMgr)
    {
        return;
    } // 0D
    ...
    virtual void PreUpdateAnimationGraphManager([[maybe_unused]] const BSTSmartPointer<BSAnimationGraphManager> &a_animGraphMgr) const
    {
        return;
    } // 16
    virtual void PostUpdateAnimationGraphManager([[maybe_unused]] const BSTSmartPointer<BSAnimationGraphManager> &a_animGraphMgr) const
    {
        return;
    } // 17
    virtual void PreLoadAnimationGraphManager([[maybe_unused]] const BSTSmartPointer<BSAnimationGraphManager> &a_animGraphMgr)
    {
        return;
    } // 18
    virtual void PostLoadAnimationGraphManager([[maybe_unused]] const BSTSmartPointer<BSAnimationGraphManager> &a_animGraphMgr)
    {
        return;
    } // 19
...
class __declspec(novtable) SimpleAnimationGraphManagerHolder : public IAnimationGraphManagerHolder
{
  public:
    ...
    // add
    virtual void BackgroundTaskFinishedLoading()
    {
        return;
    } // 01
...
class BipedAnim : public BSIntrusiveRefCounted // 0000
{
  public:
    // members
    NiNode *root;                                                        // 0008
...
class __declspec(novtable) TESObjectREFR : public TESForm,                                                 // 000
                                           ...
                                           public BSTEventSource<ActorValueEvents::ActorValueChangedEvent> // 060
{
  public:
    ...
    virtual bool GetBehaviorRootNameOverrides([[maybe_unused]] BSScrapArray<BSFixedString> &a_behaviorRoots) const
    {
        return false;
    } // 95
    ...
    virtual void SetActionComplete([[maybe_unused]] bool a_value)
    {
        return;
    } // AE
    ...
    virtual Explosion *IsExplosion()
    {
        return nullptr;
    } // B4
    virtual const Explosion *IsExplosion() const
    {
        return nullptr;
    } // B3
    ...
    virtual const Projectile *IsProjectile() const
    {
        return nullptr;
    } // B5
    virtual bool OnAddCellPerformQueueReference([[maybe_unused]] TESObjectCELL &a_cell) const
    {
        return true;
    } // B7
    ...
    [[nodiscard]] TESBoundObject *GetObjectReference() const noexcept
    {
    ...
    [[nodiscard]] NiPoint3 GetPosition() const noexcept
    {
...
class __declspec(novtable) Explosion : public TESObjectREFR // 000
{
  public:
...
class __declspec(novtable) Hazard : public TESObjectREFR // 000
{
  public:
