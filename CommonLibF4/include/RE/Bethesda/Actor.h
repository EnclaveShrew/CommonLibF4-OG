...
class __declspec(novtable) ActorPackageData
{
  public:
    ...
    virtual void SetProcedureExecState([[maybe_unused]] IProcedureTreeExecState &a_procedureExecState)
    {
        return;
    } // 03
    ...
    virtual void ResetPackData([[maybe_unused]] TESPackage *a_pack)
    {
        return;
    } // 08
};
...
class __declspec(novtable) EquippedItemData : public NiRefObject // 00
{
  public:
...
class __declspec(novtable) EquippedWeaponData : public EquippedItemData // 00
{
  public:
...
class __declspec(novtable) MagicTarget
{
  public:
    ...
    virtual void EffectAdded([[maybe_unused]] ActiveEffect *a_effect)
    {
        return;
    } // 09
    virtual void EffectRemoved([[maybe_unused]] ActiveEffect *a_effect)
    {
        return;
    } // 0A
    virtual void EffectActiveStatusChanged([[maybe_unused]] ActiveEffect *a_effect)
    {
        return;
    } // 0B
    virtual bool CheckAbsorb([[maybe_unused]] Actor *a_caster, [[maybe_unused]] MagicItem *a_spell, [[maybe_unused]] const EffectItem *a_effectItem)
    {
        return false;
    } // 0C
                                   ...
                                   public BSTEventSource<ActorCPMEvent>                           // 278
{
  public:
    ...
    virtual void GoToPrison([[maybe_unused]] TESFaction *a_faction, [[maybe_unused]] bool a_removeItems, [[maybe_unused]] bool a_realJail)
    {
        return;
    } // 0DA
...
class ActorEquipManager : public BSTSingletonSDM<ActorEquipManager>,           // 00
