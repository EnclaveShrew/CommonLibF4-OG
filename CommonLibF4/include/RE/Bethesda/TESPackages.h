...
class __declspec(novtable) TESPackage : public TESForm // 00
{
  public:
    ...
    virtual bool IsPackageOwner(Actor *)
    {
        return true;
    } // 4E
...
class __declspec(novtable) AlarmPackage : public TESPackage // 00
{
  public:
...
class __declspec(novtable) DialoguePackage : public TESPackage // 00
{
  public:
...
class __declspec(novtable) FleePackage : public TESPackage // 000
{
  public:
...
class __declspec(novtable) SpectatorPackage : public TESPackage // 000
{
  public:
...
class __declspec(novtable) TrespassPackage : public TESPackage // 00
{
  public:
