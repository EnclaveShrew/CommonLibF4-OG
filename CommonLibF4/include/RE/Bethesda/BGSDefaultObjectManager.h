...
class __declspec(novtable) BGSDefaultObjectManager : public TESForm,                                      // 00
                                                     public BSTSingletonImplicit<BGSDefaultObjectManager> // 20
{
  public:
    ...
    [[nodiscard]] TESForm *GetDefaultObject(DEFAULT_OBJECT a_obj) const noexcept
    {
        ...
        return objectInitArray[stl::to_underlying(a_obj)] ? objectArray[stl::to_underlying(a_obj)] : nullptr;
    }
...
class __declspec(novtable) BGSDefaultObject : public TESForm // 00
{
  public:
