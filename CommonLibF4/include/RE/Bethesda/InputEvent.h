...
class __declspec(novtable) CharacterEvent : public InputEvent // 00
{
  public:
...
class __declspec(novtable) DeviceConnectEvent : public InputEvent // 00
{
  public:
...
class __declspec(novtable) IDEvent : public InputEvent // 00
{
  public:
    ...
    [[nodiscard]] const bool QDisabled() const noexcept
    {
        return disabled;
    }
    [[nodiscard]] const std::uint32_t QIDCode() const noexcept
    {
        return idCode;
    }
    [[nodiscard]] const BSFixedString &QRawUserEvent() const noexcept
    {
        return strUserEvent;
    }
...
class __declspec(novtable) ButtonEvent : public IDEvent // 00
{
  public:
    ...
    [[nodiscard]] float QAnalogValue() const noexcept
    {
        return value;
    }
    [[nodiscard]] bool QHeldDown(float a_heldDownSecs) const noexcept
    {
        return value != 0.0 && a_heldDownSecs <= heldDownSecs;
    }
    [[nodiscard]] float QHeldDownSecs() const noexcept
    {
        return heldDownSecs;
    }
    [[nodiscard]] bool QJustPressed() const noexcept
    {
        return value != 0.0F && heldDownSecs == 0.0F;
    }
    [[nodiscard]] bool QReleased(float a_heldDownSecs) const noexcept
    {
        return value == 0.0F && a_heldDownSecs <= heldDownSecs;
    }
...
class __declspec(novtable) CursorMoveEvent : public IDEvent // 00
{
  public:
...
class __declspec(novtable) KinectEvent : public IDEvent // 00
{
  public:
...
class __declspec(novtable) MouseMoveEvent : public IDEvent // 00
{
  public:
...
class __declspec(novtable) ThumbstickEvent : public IDEvent // 00
{
  public:
