...
class __declspec(novtable) UIMessage
{
  public:
    ...
    virtual IUIMessageData *QData()
    {
        return nullptr;
    } // 02
    virtual const IUIMessageData *QData() const
    {
        return nullptr;
    } // 01
...
class __declspec(novtable) IUIMessageData : public UIMessage // 00
{
  public:
    ...
    // override (UIMessage)
    IUIMessageData *QData() override
    {
        return this;
    } // 02
    const IUIMessageData *QData() const override
    {
        return this;
    } // 01
};
...
class __declspec(novtable) BSUIMessageData : public IUIMessageData // 00
{
  public:
...
class __declspec(novtable) BSUIScaleformData : public IUIMessageData // 00
{
  public:
