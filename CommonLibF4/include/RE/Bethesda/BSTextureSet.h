...
struct __declspec(novtable) BSShaderProperty : public NiShadeProperty // 00
{
  public:
    ...
    virtual RenderPassArray *GetRenderPasses_ShadowMapOrMask(BSGeometry *, std::uint32_t, BSShaderAccumulator *)
    {
        return nullptr;
    } // 2C
    virtual RenderPassArray *GetRenderPasses_LocalMap(BSGeometry *, std::uint32_t, BSShaderAccumulator *)
    {
        return nullptr;
    } // 2D
    ...
    virtual std::uint16_t GetNumberofPasses([[maybe_unused]] BSGeometry *a_geom)
    {
        return 1;
    } // 2F
    ...
    virtual std::int32_t QShader() const
    {
        return 0;
    } // 36
    virtual void ClearUnusedMaterialValues()
    {
        return;
    } // 37
    ...
    virtual std::uint32_t DetermineUtilityShaderDecl() const
    {
        return 0;
    } // 3D
    virtual std::uint32_t GetMaterialType() const
    {
        return 0;
    } // 3E
...
class __declspec(novtable) BSTextureSet : public NiObject // 00
{
  public:
