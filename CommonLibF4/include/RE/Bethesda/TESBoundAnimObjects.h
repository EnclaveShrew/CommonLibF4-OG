...
class __declspec(novtable) TESBoundAnimObject : public TESBoundObject // 00
{
  public:
...
class __declspec(novtable) TESSound : public TESBoundAnimObject // 00
{
  public:
...
class __declspec(novtable) TESObjectACTI : public TESBoundAnimObject,        // 000
...
class __declspec(novtable) BGSTalkingActivator : public TESObjectACTI // 000
{
  public:
...
class __declspec(novtable) TESObjectCONT : public TESBoundAnimObject,        // 000
...
class __declspec(novtable) TESObjectDOOR : public TESBoundAnimObject,        // 000
                                           public TESFullName,               // 068
                                           public BGSModelMaterialSwap,      // 078
...
class __declspec(novtable) TESObjectLIGH : public TESBoundAnimObject,        // 000
...
class __declspec(novtable) TESFlora : public TESObjectACTI, // 000
...
class __declspec(novtable) TESFurniture : public TESObjectACTI // 000
{
  public:
...
class __declspec(novtable) TESActorBase : public TESBoundAnimObject,        // 000
...
class __declspec(novtable) TESNPC : public TESActorBase,                    // 000
...
class __declspec(novtable) TESLevCharacter : public TESBoundAnimObject,  // 00
...
class __declspec(novtable) BGSTerminal : public TESFurniture // 000
{
  public:
