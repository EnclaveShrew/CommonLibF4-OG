...
class BSNavmeshCoverEdge : public BSNavmeshCoverEdgeBase // 0
{
  public:
    // members
...
class __declspec(novtable) BSNavmesh : public BSIntrusiveRefCounted // 008
{
  public:
...
class __declspec(novtable) NavMesh : public TESForm,      // 00
                                     ...
                                     public BSNavmesh     // 28
{
  public:
    ...
    virtual bool SavesBefore([[maybe_unused]] FORM *a_groupFORM)
    {
        return false;
    } // 4B
    virtual bool SavesBefore([[maybe_unused]] TESForm *a_form)
    {
        return false;
    } // 4C
