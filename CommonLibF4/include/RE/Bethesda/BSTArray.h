...
class BSTArrayHeapAllocator
{
  public:
    ...
    void set_capacity(size_type a_capacity, size_type) noexcept
    {
  ...
  public:
    class Allocator
    {
      public:
        ...
        [[nodiscard]] void *allocate(uint32_t a_bytes)
        {
            return aligned_alloc(N, a_bytes);
        }
        void deallocate(void *a_ptr)
        {
            aligned_free(a_ptr);
...
class BSTArray : public boost::stl_interfaces::sequence_container_interface<
                     ...
                     boost::stl_interfaces::element_layout::contiguous>
{
  ...
  public:
    ...
    // 3)
    explicit BSTArray(size_type a_count, const_reference a_value)
    {
    ...
    {
        return static_cast<pointer>(_allocator.data());
    }
...
class BSTSmallSharedArray
{
  public:
    ...
    ~BSTSmallSharedArray()
    {
        stl::report_and_fail("unimplemented"sv);
    }
