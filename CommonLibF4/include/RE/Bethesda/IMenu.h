...
class __declspec(novtable) FlatScreenModel : public BSTEventSink<UIAdvanceMenusFunctionCompleteEvent>, // 00
...
class __declspec(novtable) GameUIModel : public BSTSingletonSDM<GameUIModel>,
...
class IMenu : public SWFToCodeFunctionHandler, // 00
              public BSInputEventUser          // 10
{
  public:
    ...
    virtual void SetIsTopButtonBar([[maybe_unused]] bool a_isTopButtonBar)
    {
        return;
    } // 08
    ...
    virtual void OnMenuDisplayStateChanged()
    {
        return;
    } // 0A
    ...
    virtual bool CanHandleWhenDisabled([[maybe_unused]] const ButtonEvent *a_event)
    {
        return false;
    } // 0E
    virtual bool OnButtonEventRelease([[maybe_unused]] const BSFixedString &a_eventName)
    {
        return false;
    } // 0F
    virtual bool CacheShaderFXQuadsForRenderer_Impl()
    {
        return false;
    } // 10
    virtual void TransferCachedShaderFXQuadsForRenderer([[maybe_unused]] const BSFixedString &a_rendererName)
    {
        return;
    } // 11
    virtual void SetViewportRect([[maybe_unused]] const NiRect<float> &a_viewportRect)
    {
        return;
    } // 12

    [[nodiscard]] bool AdvancesUnderPauseMenu() const noexcept
    {
        return menuFlags.all(UI_MENU_FLAGS::kAdvancesUnderPauseMenu);
    }
    [[nodiscard]] bool AssignsCursorToRenderer() const noexcept
    {
        return menuFlags.all(UI_MENU_FLAGS::kAssignCursorToRenderer);
    }
    ...
    [[nodiscard]] bool OnStack() const noexcept
    {
        return menuFlags.all(UI_MENU_FLAGS::kOnStack);
    }
    ...
    [[nodiscard]] bool RendersUnderPauseMenu() const noexcept
    {
        return menuFlags.all(UI_MENU_FLAGS::kRendersUnderPauseMenu);
    }

    [[nodiscard]] constexpr bool IsMenuDisplayEnabled() const noexcept
    {
    ...
    [[nodiscard]] bool UsesCursor() const noexcept
    {
        return menuFlags.all(UI_MENU_FLAGS::kUsesCursor);
    }
...
class __declspec(novtable) BSGFxFunctionHandler : public Scaleform::GFx::FunctionHandler // 00
{
  public:
...
class BSGFxObject : public Scaleform::GFx::Value,   // 00
...
class BSGFxDisplayObject : public BSGFxObject // 00
{
  public:
...
class BSGFxShaderFXTarget : public BSGFxDisplayObject,                 // 00
...
class __declspec(novtable) ButtonHintBar : public BSGFxShaderFXTarget // 00
{
  public:
...
class GameMenuBase : public IMenu // 00
{
  public:
...
struct __declspec(novtable) Console : public GameMenuBase // 00
{
  public:
    ...
    [[nodiscard]] static ObjectRefHandle GetCurrentPickREFR()
    {
        ...
        return 0 <= idx && static_cast<std::size_t>(idx) < refs.size() ? refs[static_cast<std::size_t>(idx)] : ObjectRefHandle{};
    }
...
struct DisplayItemModel : public BaseLoadedInventoryModel // 00
{
  public:
    // members
...
class __declspec(novtable) Inventory3DManager : public BSInputEventUser // 000
{
  public:
...
class __declspec(novtable) WorkshopMenu : public GameMenuBase,                                // 000
                                          ...
                                          public BSTEventSink<Workshop::PlacementStatusEvent> // 0F8
{
  public:
    ...
    class FXWorkshopMenu : public BSGFxShaderFXTarget // 000
    {
      public:
        // members
...
class __declspec(novtable) PipboySubMenu : public BSTEventSink<PipboyValueChangedEvent> // 00
{
  public:
...
class __declspec(novtable) PipboyStatsMenu : public PipboySubMenu // 00
{
  public:
...
class __declspec(novtable) PipboySpecialMenu : public PipboySubMenu // 00
{
  public:
...
class __declspec(novtable) PipboyPerksMenu : public PipboySubMenu // 00
{
  public:
...
class __declspec(novtable) PipboyInventoryMenu : public PipboySubMenu // 00
{
  public:
...
class __declspec(novtable) PipboyQuestMenu : public PipboySubMenu // 00
{
  public:
...
class __declspec(novtable) PipboyWorkshopMenu : public PipboySubMenu // 00
{
  public:
...
class __declspec(novtable) PipboyLogMenu : public PipboySubMenu // 00
{
  public:
...
class __declspec(novtable) PipboyMapMenu : public PipboySubMenu // 00
{
  public:
...
class __declspec(novtable) PipboyRadioMenu : public PipboySubMenu // 00
{
  public:
...
class __declspec(novtable) PipboyPlayerInfoMenu : public PipboySubMenu // 00
{
  public:
...
class __declspec(novtable) PipboyMenu : public GameMenuBase,                     // 000
...
class __declspec(novtable) CursorMenu : public GameMenuBase // 00
{
  public:
...
class __declspec(novtable) InventoryUserUIInterface : public BSTEventSource<InvInterfaceStateChangeEvent> // 00
{
  public:
    // members
...
class __declspec(novtable) ContainerMenuBase : public GameMenuBase,                               // 000
                                               ...
                                               public BSTEventSink<MenuOpenCloseEvent>            // 0E8
{
  public:
    ...
    class __declspec(novtable) FXQuantityMenu : public BSGFxShaderFXTarget // 000
    {
      public:
        // members
    ...
    virtual bool GetCanEquipItem([[maybe_unused]] std::uint32_t a_itemIndex, [[maybe_unused]] bool a_inContainer)
    {
        return false;
    } // 17
    virtual bool GetIsItemEquipped([[maybe_unused]] std::uint32_t a_itemIndex, [[maybe_unused]] bool a_inContainer)
    {
        return false;
    } // 18
...
class __declspec(novtable) ContainerMenu : public ContainerMenuBase // 000
{
  public:
...
class __declspec(novtable) BarterMenuTentativeInventoryUIInterface : public InventoryUserUIInterface // 00
{
  public:
};
static_assert(sizeof(BarterMenuTentativeInventoryUIInterface) == 0x80);

class __declspec(novtable) BarterMenu : public ContainerMenuBase // 000
{
  public:
...
class __declspec(novtable) MessageBoxMenu : public GameMenuBase,                     // 00
...
class __declspec(novtable) WorkbenchMenuBase : public GameMenuBase // 00
{
  public:
...
class __declspec(novtable) ExamineConfirmMenu : public GameMenuBase // 00
{
  public:
    ...
    class __declspec(novtable) InitDataScrap : public InitData // 00
    {
      public:
...
class __declspec(novtable) ScrapItemCallback : public ExamineConfirmMenu::ICallback // 00
{
  public:
...
class __declspec(novtable) ExamineMenu : public WorkbenchMenuBase // 00
{
  public:
...
class __declspec(novtable) LockpickingMenu : public GameMenuBase // 00
{
  public:
...
class __declspec(novtable) SitWaitMenu : public GameMenuBase // 00
{
  public:
...
{
class IEventCallback : public BSIntrusiveRefCounted // 00
{
  public:
...
class __declspec(novtable) TerminalMenu : public GameMenuBase // 00
{
  public:
...
class __declspec(novtable) TerminalMenuButtons : public GameMenuBase // 00
{
  public:
...
class __declspec(novtable) HolotapeMenu : public GameMenuBase,                    // 00
...
class __declspec(novtable) PipboyHolotapeMenu : public HolotapeMenu // 00
{
  public:
...
class __declspec(novtable) TerminalHolotapeMenu : public HolotapeMenu // 00
{
  public:
...
class __declspec(novtable) PowerArmorModMenu : public ExamineMenu
{
  public:
