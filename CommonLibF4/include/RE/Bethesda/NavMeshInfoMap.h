...
class __declspec(novtable) BSNavmeshInfoMap : public BSTSingletonExplicit<BSNavmeshInfoMap> // 0
{
  public:
...
class BSPrecomputedNavmeshInfoPathMap : public BSTSingletonExplicit<BSPrecomputedNavmeshInfoPathMap> // 00
{
  public:
...
class PrecomputedNavmeshInfoPathMap : public BSPrecomputedNavmeshInfoPathMap // 00
{
  public:
...
class __declspec(novtable) NavMeshInfoMap : public TESForm,                      // 000
