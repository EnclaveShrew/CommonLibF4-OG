...
class TESCameraState : public BSIntrusiveRefCounted, // 10
                       public BSInputEventUser       // 00
{
  public:
    ...
    virtual void SaveGame([[maybe_unused]] BGSSaveFormBuffer *a_saveGameBuffer)
    {
        return;
    } // 0E
    virtual void LoadGame([[maybe_unused]] BGSLoadFormBuffer *a_loadGameBuffer)
    {
        return;
    } // 0F
...
class __declspec(novtable) ThirdPersonState : public TESCameraState // 000
{
  public:
    static constexpr auto RTTI{RTTI::TESCamera};
    static constexpr auto VTABLE{VTABLE::TESCamera};
...
class __declspec(novtable) PlayerCamera : public TESCamera,                            // 000
