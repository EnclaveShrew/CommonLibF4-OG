...
namespace RE
{
class __declspec(novtable) BSTempEffect : public NiObject // 00
{
  public:
    ...
    virtual bool GetManagerHandlesSaveLoad()
    {
        return false;
    };
    ...
    virtual bool IsInterfaceEffect()
    {
        return false;
    };
    virtual void SetInterfaceEffect()
    {
        return;
    };
    virtual bool GetStackable()
    {
        return false;
    };
    virtual bool GetStackableMatch(BSTempEffect *)
    {
        return false;
    };
    virtual void Push()
    ...
    virtual void HandleDeferredDeleteImpl()
    {
        return;
    };
