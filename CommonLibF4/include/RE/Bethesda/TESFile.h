...
class __declspec(novtable) BSFile : public NiFile // 000
{
  public:
...
class TESFile
{
  public:
    ...
    [[nodiscard]] std::uint8_t GetCompileIndex() const noexcept
    {
        return compileIndex;
    }
    ...
    [[nodiscard]] std::uint16_t GetSmallFileCompileIndex() const noexcept
    {
        return smallFileCompileIndex;
    }
    [[nodiscard]] bool IsActive() const noexcept
    {
        return GetCompileIndex() != 0xFF;
    }
    [[nodiscard]] bool IsLight() const noexcept
    {
        return flags.all(RecordFlag::kSmallFile);
    };
