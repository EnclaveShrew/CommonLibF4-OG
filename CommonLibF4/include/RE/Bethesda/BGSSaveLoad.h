...
struct BGSNumericIDIndex
{
  public:
    ...
    {
        return flags.all(Flags::kCreated);
    }
    [[nodiscard]] bool IsDefault() const noexcept
    {
        return flags.all(Flags::kDefault);
    }
...
class alignas(0x80) BGSSaveLoadThread : public BSThread // 00
{
  public:
    struct AsyncRequest
    {
...
class BGSSaveLoadManager : public BSTEventSink<SPECIALMenuEvent::NameChangedEvent> // 00
{
  public:
