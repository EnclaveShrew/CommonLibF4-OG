...
class PlayerInputHandler : public BSInputEventUser // 00
{
  public:
...
class HeldStateHandler : public PlayerInputHandler // 00
{
  public:
...
class __declspec(novtable) PlayerControls : BSInputEventReceiver,                   // 000
                                            ...
                                            BSTSingletonSDM<PlayerControls>         // 040
{
  public:
    ...
    {
        DoRegisterHandler(a_handler, false);
    }
    void RegisterHandler(HeldStateHandler *a_handler)
    {
        DoRegisterHandler(a_handler, true);
    }
