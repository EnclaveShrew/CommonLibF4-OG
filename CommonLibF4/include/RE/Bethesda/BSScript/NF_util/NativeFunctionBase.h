...
namespace NF_util
{
class __declspec(novtable) NativeFunctionBase : public IFunction // 00
{
  public:
    ...
    void InsertLocals(StackFrame &) const override
    {
        return;
    } // 0E
    ...
    {
        return isCallableFromTasklet;
    } // 13
    void SetCallableFromTasklets(bool a_taskletCallable) override
    {
        isCallableFromTasklet = a_taskletCallable;
    } // 14
