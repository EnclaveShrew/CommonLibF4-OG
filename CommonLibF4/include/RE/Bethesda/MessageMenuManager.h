...
class alignas(0x10) IMessageBoxCallback : public BSIntrusiveRefCounted // 00
{
  public:
...
class __declspec(novtable) MessageBoxData : public IUIMessageData // 00
{
  public:
...
class MessageMenuManager : public BSTSingletonSDM<MessageMenuManager> // 00
{
  public:
