...
class TESFileArray : public BSStaticArray<TESFile *> // 00
{
  public:
};
...
class __declspec(novtable) TESForm : public BaseFormComponent // 00
{
  public:
    ...
    virtual bool Load([[maybe_unused]] TESFile *a_file)
    {
        return true;
    } // 09
    virtual bool LoadPartial([[maybe_unused]] TESFile *a_file)
    {
        return true;
    } // 0A
    ...
    virtual bool FindInFileFast([[maybe_unused]] TESFile *a_file)
    {
        return false;
    } // 0F
    ...
    virtual void FinishLoadGame([[maybe_unused]] BGSLoadFormBuffer *a_loadGameBuffer)
    {
        return;
    } // 14
    virtual void Revert([[maybe_unused]] BGSLoadFormBuffer *a_loadGameBuffer)
    {
        return;
    } // 15
    ...
    {
        return (formFlags >> 6) & 1;
    } // 1B
    virtual bool GetRandomAnim() const
    {
        return (formFlags >> 16) & 1;
    } // 1C
    virtual bool GetPlayable([[maybe_unused]] const TBO_InstanceData *a_data) const
    {
        return (formFlags >> 2) & 1;
    } // 1D
    virtual bool IsHeadingMarker() const
    {
        return false;
    } // 1E
    virtual bool IsHeadtrackMarker() const
    {
        return false;
    } // 1F
    virtual bool GetDangerous() const
    {
        return (formFlags >> 17) & 1;
    } // 20
    virtual bool QHasCurrents() const
    {
        return (formFlags >> 19) & 1;
    } // 21
    virtual bool GetObstacle() const
    {
        return (formFlags >> 25) & 1;
    } // 22
    ...
    virtual void LoadObjectBound([[maybe_unused]] TESFile *a_file)
    {
        return;
    } // 2B
    virtual void SavePreviewTransform(CHUNK_ID)
    {
        return;
    } // 2C
    virtual void LoadPreviewTransform([[maybe_unused]] TESFile *a_file)
    {
        return;
    } // 2D
    ...
    virtual TESObjectREFR *IsReference()
    {
        return nullptr;
    } // 33
    virtual const TESObjectREFR *IsReference() const
    {
        return nullptr;
    } // 32
    ...
    virtual bool SetFormEditorID([[maybe_unused]] const char *a_editorID)
    {
        return true;
    } // 3B
    ...
    virtual bool IsFormTypeChild([[maybe_unused]] std::uint8_t a_type)
    {
        return false;
    } // 3E
    virtual bool LoopingActivate(TESObjectREFR *a_itemActivated, TESObjectREFR *a_actionRef)
    {
        return Activate(a_itemActivated, a_actionRef, nullptr, 1);
    } // 3F
    ...
    virtual BGSMod::Template::Items *GetObjectTemplate()
    {
        return nullptr;
    } // 44
    virtual BGSPreviewTransform *GetPreviewTransform()
    {
        return nullptr;
    } // 45
    ...
    virtual float GetDesirability([[maybe_unused]] TBO_InstanceData *a_instanceData, [[maybe_unused]] const TESForm *a_user) const
    {
        return 0.0F;
    } // 49
    ...
    [[nodiscard]] std::uint32_t GetFormFlags() const noexcept
    {
        return formFlags;
    }
    [[nodiscard]] std::uint32_t GetFormID() const noexcept
    {
        return formID;
    }
    [[nodiscard]] ENUM_FORM_ID GetFormType() const noexcept
    {
        return *formType;
    }
    ...
    [[nodiscard]] bool Is(ENUM_FORM_ID a_type) const noexcept
    {
    ...
    {
        return Is(ENUM_FORM_ID::kALCH);
    }
    [[nodiscard]] bool IsCreated() const noexcept
    {
        return (formID >> (8 * 3)) == 0xFF;
    }
    [[nodiscard]] bool IsDeleted() noexcept
    {
        return (formFlags & (1u << 5)) != 0;
    }
    [[nodiscard]] bool IsInitialized() const noexcept
    {
        return (formFlags & (1u << 3)) != 0;
    }

    [[nodiscard]] bool IsNot(ENUM_FORM_ID a_type) const noexcept
    {
        return !Is(a_type);
    }
    template <class... Args>
...
class __declspec(novtable) BGSKeyword : public TESForm // 00
{
  public:
...
class __declspec(novtable) BGSLocationRefType : public BGSKeyword // 00
{
  public:
...
class __declspec(novtable) BGSAction : public BGSKeyword // 00
{
  public:
...
class __declspec(novtable) BGSTransform : public TESForm // 00
{
  public:
...
class __declspec(novtable) BGSMenuIcon : public TESForm, // 00
                                         public TESIcon  // 20
{
  public:
...
class __declspec(novtable) TESGlobal : public TESForm // 00
{
  public:
...
class __declspec(novtable) BGSDamageType : public TESForm // 00
{
  public:
...
class __declspec(novtable) TESClass : public TESForm,         // 00
...
class __declspec(novtable) TESEyes : public TESForm,     // 00
                                     public TESFullName, // 20
...
class __declspec(novtable) EffectSetting : public TESForm,              // 000
...
class __declspec(novtable) TESLandTexture : public TESForm // 00
{
  public:
...
class __declspec(novtable) TESWeather : public TESForm // 000
{
  public:
...
class __declspec(novtable) TESClimate : public TESForm // 00
{
  public:
...
class __declspec(novtable) BGSShaderParticleGeometryData : public TESForm // 00
{
  public:
...
class __declspec(novtable) BGSReferenceEffect : public TESForm // 00
{
  public:
...
class __declspec(novtable) TESRegion : public TESForm // 00
{
  public:
...
class __declspec(novtable) TESObjectCELL : public TESForm,    // 00
                                           public TESFullName // 20
{
  public:
    ...
    {
        return cellFlags.all(Flag::kHasWater);
    }
    ...
    {
        return cellFlags.all(Flag::kInterior);
    }
...
class __declspec(novtable) TESObjectLAND : public TESForm,     // 00
...
class __declspec(novtable) TESTopic : public TESForm,    // 00
                                      public TESFullName // 20
{
  public:
...
class __declspec(novtable) TESTopicInfo : public TESForm // 00
{
  public:
...
class __declspec(novtable) TESIdleForm : public TESForm // 00
{
  public:
...
class __declspec(novtable) TESLoadScreen : public TESForm // 00
{
  public:
...
class __declspec(novtable) TESObjectANIO : public TESForm,             // 00
...
class __declspec(novtable) TESEffectShader : public TESForm, // 000
                                             public TESModel // 020
{
  public:
...
class __declspec(novtable) BGSDebris : public TESForm,       // 00
...
class __declspec(novtable) TESImageSpace : public TESForm // 00
{
  public:
...
class __declspec(novtable) TESImageSpaceModifier : public TESForm // 000
{
  public:
...
class __declspec(novtable) BGSListForm : public TESForm // 00
{
  public:
...
class __declspec(novtable) BGSPerk : public TESForm,        // 00
                                     public TESFullName,    // 20
                                     public TESDescription, // 30
                                     public TESIcon         // 48
{
...
class __declspec(novtable) BGSBodyPartData : public TESForm,       // 000
                                             public TESModel,      // 020
...
class __declspec(novtable) BGSCameraShot : public TESForm,                    // 00
                                           public TESModel,                   // 20
...
class __declspec(novtable) BGSCameraPath : public TESForm // 00
{
  public:
...
class __declspec(novtable) BGSVoiceType : public TESForm // 00
{
  public:
...
class __declspec(novtable) BGSMaterialType : public TESForm // 00
{
  public:
...
class __declspec(novtable) BGSImpactData : public TESForm, // 00
                                           public TESModel // 20
{
  public:
...
class __declspec(novtable) BGSImpactDataSet : public TESForm,       // 00
                                              public BGSPreloadable // 20
{
  public:
...
class __declspec(novtable) BGSEncounterZone : public TESForm // 00
{
  public:
    ...
    [[nodiscard]] bool NeverResets() const noexcept
    {
        return data.flags.all(ENCOUNTER_ZONE_DATA::FLAG::kNeverReset);
    }
    [[nodiscard]] bool IsWorkshop() const noexcept
    {
        return data.flags.all(ENCOUNTER_ZONE_DATA::FLAG::kWorkshopZone);
    }
...
class __declspec(novtable) BGSLocation : public TESForm,       // 000
                                         public TESFullName,   // 020
...
class __declspec(novtable) BGSMessage : public TESForm,       // 00
                                        public TESFullName,   // 20
                                        public TESDescription // 30
{
  public:
...
class __declspec(novtable) BGSLightingTemplate : public TESForm // 00
{
  public:
...
class __declspec(novtable) BGSMusicType : public TESForm,     // 00
...
class __declspec(novtable) BGSFootstep : public TESForm // 00
{
  public:
...
class __declspec(novtable) BGSFootstepSet : public TESForm // 00
{
  public:
...
class __declspec(novtable) BGSDialogueBranch : public TESForm // 00
{
  public:
...
class __declspec(novtable) BGSMusicTrackFormWrapper : public TESForm,      // 00
...
class __declspec(novtable) TESWordOfPower : public TESForm,    // 00
                                            public TESFullName // 20
{
  public:
...
class __declspec(novtable) TESShout : public TESForm,              // 00
                                      public TESFullName,          // 20
...
class __declspec(novtable) BGSEquipSlot : public TESForm // 00
{
  public:
...
class __declspec(novtable) BGSRelationship : public TESForm // 00
{
  public:
...
class __declspec(novtable) BGSScene : public TESForm,         // 00
...
class __declspec(novtable) BGSAssociationType : public TESForm // 00
{
  public:
...
class __declspec(novtable) BGSOutfit : public TESForm // 00
{
  public:
...
class __declspec(novtable) BGSMaterialObject : public TESForm,         // 00
                                               public TESModel,        // 20
...
class __declspec(novtable) BGSMovementType : public TESForm // 00
{
  public:
...
class __declspec(novtable) BGSSoundDescriptorForm : public TESForm,           // 00
...
class __declspec(novtable) BGSSoundCategory : public TESForm,         // 00
                                              public TESFullName,     // 20
...
class __declspec(novtable) BGSSoundOutput : public TESForm,            // 00
...
class __declspec(novtable) BGSCollisionLayer : public TESForm,       // 00
...
class __declspec(novtable) BGSColorForm : public TESForm,    // 00
                                          public TESFullName // 20
{
  public:
...
class __declspec(novtable) BGSReverbParameters : public TESForm,      // 00
...
class __declspec(novtable) BGSPackIn : public TESForm // 00
{
  public:
...
class __declspec(novtable) BGSAimModel : public TESForm // 00
{
  public:
...
class __declspec(novtable) BGSConstructibleObject : public TESForm,                // 00
                                                    ...
                                                    public TESDescription          // 38
{
  public:
    ...
    [[nodiscard]] TESForm *GetCreatedItem() const noexcept
    {
        return createdItem;
    }
    [[nodiscard]] std::uint16_t GetWorkshopPriority() const noexcept
    {
        return data.workshopPriority;
    }
...
class __declspec(novtable) BGSMaterialSwap : public TESForm // 00
{
  public:
...
class __declspec(novtable) BGSZoomData : public TESForm // 00
{
  public:
...
class __declspec(novtable) BGSInstanceNamingRules : public TESForm // 000
{
  public:
    ...
    struct RuleSet : public BSTArray<RuleData> // 00
    {
      public:
    };
...
class __declspec(novtable) BGSSoundKeywordMapping : public TESForm // 00
{
  public:
...
class __declspec(novtable) BGSAudioEffectChain : public TESForm,            // 00
...
class __declspec(novtable) BGSAttractionRule : public TESForm // 00
{
  public:
...
class __declspec(novtable) BGSSoundCategorySnapshot : public TESForm // 00
{
  public:
...
class __declspec(novtable) BGSSoundTagSet : public TESForm // 00
{
  public:
...
class __declspec(novtable) BGSLensFlare : public TESForm,              // 00
...
class __declspec(novtable) BGSGodRays : public TESForm // 00
{
  public:
