...
class __declspec(novtable) Projectile : public TESObjectREFR // 000
{
  public:
    ...
    // add
    virtual bool IsMissileProjectile() const
    {
        return false;
    } // C6
    virtual bool IsGrenadeProjectile() const
    {
        return false;
    } // C7
    virtual bool IsFlameProjectile() const
    {
        return false;
    } // C8
    virtual bool IsBeamProjectile() const
    {
        return false;
    } // C9
    virtual bool IsFogProjectile() const
    {
        return false;
    } // CA
    virtual bool IsBarrierProjectile() const
    {
        return false;
    } // CB
    virtual void OnKill()
    ...
    {
        return spell ? 1.0F : power;
    } // D3
    virtual float GetWeaponSpeedMult() const
    {
        return 1.0F;
    } // D4
    virtual bool GetStopMainSoundAfterImpact() const
    {
        return false;
    } // D5
    ...
    virtual bool GetKillOnCollision() const
    {
        return true;
    } // DC
    virtual bool ShouldBeLimited() const
    {
        return false;
    } // DD
...
class __declspec(novtable) MissileProjectile : public Projectile // 000
{
  public:
...
class __declspec(novtable) ArrowProjectile : public MissileProjectile // 000
{
  public:
...
class __declspec(novtable) GrenadeProjectile : public Projectile // 000
{
  public:
...
class __declspec(novtable) BeamProjectile : public Projectile,                                // 000
...
class __declspec(novtable) FlameProjectile : public Projectile // 000
{
  public:
...
class __declspec(novtable) ConeProjectile : public Projectile // 000
{
  public:
...
class __declspec(novtable) BarrierProjectile : public Projectile // 000
{
  public:
