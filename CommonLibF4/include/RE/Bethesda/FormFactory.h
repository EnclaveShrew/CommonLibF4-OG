...
class __declspec(novtable) ConcreteFormFactory : public IFormFactory // 00
{
  public:
...
class __declspec(novtable) ConcreteObjectFormFactory : public ConcreteFormFactory<T, ID> // 00
{
  public:
};

class DefaultObjectFormFactory : public IFormFactory // 00
{
  public:
    ...
    [[nodiscard]] const char *GetFormName() const override
    {
        return "DefaultObject";
    } // 02
    [[nodiscard]] ENUM_FORM_ID GetFormID() const override
    {
        return ENUM_FORM_ID::kDFOB;
    } // 03
