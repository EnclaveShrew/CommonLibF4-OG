...
class __declspec(novtable) MagicItem : public TESBoundObject, // 00
                                       ...
                                       public BGSKeywordForm  // 70
{
  public:
    ...
    virtual void AdjustCost(float &, Actor *) const
    {
        return;
    } // 77
    ...
    virtual ActorValueInfo *GetAssociatedSkill() const
    {
        return nullptr;
    } // 7A
...
class __declspec(novtable) EnchantmentItem : public MagicItem // 00
{
  public:
    ...
    class Data : public MagicItem::Data // 00
    {
      public:
        // members
...
class __declspec(novtable) SpellItem : public MagicItem,            // 000
...
class __declspec(novtable) ScrollItem : public SpellItem,                 // 000
...
class __declspec(novtable) IngredientItem : public MagicItem,                 // 000
...
class __declspec(novtable) AlchemyItem : public MagicItem,                 // 000
                                         public BGSModelMaterialSwap,      // 0D0
                                         public TESIcon,                   // 110
