...
class __declspec(novtable) Setting
{
  public:
    ...
    // add
    [[nodiscard]] virtual bool IsPrefSetting()
    {
        return false;
    } // 01
...
template <class T>
class __declspec(novtable) SettingT : public Setting // 00
{
  public:
};
...
class __declspec(novtable) SettingCollection
{
  public:
    ...
    virtual bool Open([[maybe_unused]] bool a_write)
    {
        return false;
    } // 05
    virtual bool Close()
...
template <class T>
class __declspec(novtable) SettingCollectionMap : public SettingCollection<T> // 000
{
  public:
    // members
...
template <class T>
class __declspec(novtable) SettingCollectionList : public SettingCollection<T>
{
  public:
    // members
...
class __declspec(novtable) GameSettingCollection : public SettingCollectionMap<Setting> // 000
{
  public:
...
class __declspec(novtable) INISettingCollection : public SettingCollectionList<Setting> // 000
{
  public:
...
class __declspec(novtable) INIPrefSettingCollection : public INISettingCollection // 000
{
  public:
