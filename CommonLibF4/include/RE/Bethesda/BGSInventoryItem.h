...
{
  public:
    class __declspec(novtable) Stack : public BSIntrusiveRefCounted // 08
    {
      public:
        ...
        [[nodiscard]] bool IsEquipped() const noexcept
        {
            return flags.any(Flag::kSlotMask);
        }
    ...
    class __declspec(novtable) StackDataCompareFunctor
    {
      public:
        ...
        virtual bool UseDefaultStackIfNoMatch() const
        {
            return false;
        } // 01
    };
    ...
    class alignas(0x08) CheckStackIDFunctor : public StackDataCompareFunctor // 00
    {
      public:
        ...
        bool CompareData(const BGSInventoryItem::Stack &) override
        {
    ...
    class __declspec(novtable) ModifyModDataFunctor : public StackDataWriteFunctor // 00
    {
      public:
...
class __declspec(novtable) ApplyChangesFunctor : public BGSInventoryItem::StackDataWriteFunctor // 00
{
  public:
