...
class __declspec(novtable) TESObject : public TESForm // 00
{
  public:
...
class __declspec(novtable) TESBoundObject : public TESObject // 00
{
  public:
    ...
    // add
    virtual TBO_InstanceData *CreateInstanceData(const TBO_InstanceData *) const
    {
        return nullptr;
    } // 56
    virtual const TBO_InstanceData *GetBaseInstanceData() const
    {
        return nullptr;
    } // 57
    ...
    virtual void SetAttachedMarkersVisible(NiAVObject *, bool) const
    {
        return;
    } // 59
    virtual bool QSupportsCountPerInstance() const
    {
        return false;
    } // 5A
    virtual void SetObjectVoiceType(BGSVoiceType *)
    {
        return;
    } // 5B
    ...
    virtual void HandleRemoveItemFromContainer(TESObjectREFR *)
    {
        return;
    } // 62
    virtual void OnRemove3D(NiAVObject *)
    {
        return;
    } // 63
...
class __declspec(novtable) BGSComponent : public TESBoundObject,     // 00
...
class __declspec(novtable) BGSAcousticSpace : public TESBoundObject // 00
{
  public:
...
class __declspec(novtable) TESObjectARMO : public TESBoundObject,            // 000
                                           ...
                                           public BGSInstanceNamingRulesForm // 240
{
  public:
    ...
    struct __declspec(novtable) InstanceData : public TBO_InstanceData // 00
    {
      public:
...
class __declspec(novtable) TESObjectBOOK : public TESBoundObject,            // 000
                                           public TESFullName,               // 068
...
class __declspec(novtable) TESObjectMISC : public TESBoundObject,            // 000
                                           public TESFullName,               // 068
                                           public BGSModelMaterialSwap,      // 078
                                           public TESIcon,                   // 0B8
                                           public TESValueForm,              // 0C8
                                           ...
                                           public BGSFeaturedItemMessage     // 148
{
  public:
    ...
    virtual void LoadImpl(TESFile *, CHUNK_ID)
    {
        return;
    } // 68
...
class __declspec(novtable) TESObjectSTAT : public TESBoundObject,       // 00
...
class __declspec(novtable) BGSStaticCollection : public TESBoundObject,      // 00
                                                 public BGSModelMaterialSwap // 68
{
  public:
...
class __declspec(novtable) BGSMovableStatic : public TESObjectSTAT,             // 000
                                              public BGSDestructibleObjectForm, // 0E8
...
class __declspec(novtable) TESGrass : public TESBoundObject, // 00
                                      public TESModel        // 68
{
  public:
    ...
    {
        return data.distanceFromWaterLevel;
    } // 6F
    virtual void SetDistanceFromWaterLevel(const std::uint16_t a_distanceFromWaterLevel)
    {
        data.distanceFromWaterLevel = a_distanceFromWaterLevel;
    } // 70
    virtual GRASS_WATER_STATE GetUnderwaterState() const
    {
        return *data.underwater;
    } // 71
    virtual void SetUnderwaterState(const GRASS_WATER_STATE a_underwater)
    {
        data.underwater = a_underwater;
    } // 72
...
class __declspec(novtable) TESObjectTREE : public TESBoundObject,       // 000
...
class __declspec(novtable) TESObjectWEAP : public TESBoundObject,            // 000
                                           public TESFullName,               // 068
                                           public BGSModelMaterialSwap,      // 078
                                           public TESIcon,                   // 0B8
                                           ...
                                           public BGSInstanceNamingRulesForm // 188
{
  public:
    ...
    struct __declspec(novtable) InstanceData : public TBO_InstanceData // 000
    {
      public:
    ...
    struct __declspec(novtable) Data : public InstanceData // 000
    {
      public:
...
class __declspec(novtable) TESAmmo : public TESBoundObject,            // 000
                                     public TESFullName,               // 068
                                     public BGSModelMaterialSwap,      // 078
                                     public TESIcon,                   // 0B8
...
class __declspec(novtable) TESKey : public TESObjectMISC // 000
{
  public:
...
class __declspec(novtable) BGSIdleMarker : public TESBoundObject,   // 00
...
class __declspec(novtable) BGSNote : public TESBoundObject,        // 000
...
class __declspec(novtable) BGSProjectile : public TESBoundObject,           // 000
                                           public TESFullName,              // 068
                                           public TESModel,                 // 078
...
class __declspec(novtable) BGSHazard : public TESBoundObject,             // 000
                                       public TESFullName,                // 068
                                       public TESModel,                   // 078
                                       public BGSPreloadable,             // 0A8
...
class __declspec(novtable) BGSBendableSpline : public TESBoundObject // 00
{
  public:
    ...
    struct SplineData : public SplineData_Untilv130 // 00
    {
      public:
        // members
...
class __declspec(novtable) TESSoulGem : public TESObjectMISC // 000
{
  public:
...
class __declspec(novtable) TESLevItem : public TESBoundObject, // 00
...
class __declspec(novtable) TESLevSpell : public TESBoundObject, // 00
                                         public TESLeveledList  // 68
{
  public:
...
class __declspec(novtable) BGSExplosion : public TESBoundObject,             // 000
                                          public TESFullName,                // 068
                                          public TESModel,                   // 078
...
class __declspec(novtable) BGSAddonNode : public TESBoundObject,      // 00
                                          public BGSModelMaterialSwap // 68
{
  public:
...
class __declspec(novtable) TESObjectARMA : public TESObject,         // 000
...
class __declspec(novtable) BGSArtObject : public TESBoundObject,      // 00
                                          public BGSKeywordForm,      // 68
...
class __declspec(novtable) BGSDualCastData : public TESBoundObject // 00
{
  public:
