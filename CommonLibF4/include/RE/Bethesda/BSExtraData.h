...
class __declspec(novtable) BSExtraData
{
  public:
    ...
    [[nodiscard]] EXTRA_DATA_TYPE GetExtraType() const noexcept
    {
        return *type;
    }
...
class __declspec(novtable) ExtraCellWaterType : public BSExtraData // 00
{
  public:
...
class __declspec(novtable) ExtraReferenceHandles : public BSExtraData // 00
{
  public:
...
class __declspec(novtable) ExtraHealth : public BSExtraData // 00
{
  public:
...
class __declspec(novtable) ExtraLock : public BSExtraData // 00
{
  public:
...
class __declspec(novtable) ExtraTeleport : public BSExtraData // 00
{
  public:
...
class __declspec(novtable) ExtraInstanceData : public BSExtraData // 00
{
  public:
...
class __declspec(novtable) BGSObjectInstanceExtra : public BSExtraData // 00
{
  public:
...
class __declspec(novtable) ExtraStartingWorldOrCell : public BSExtraData // 00
{
  public:
...
class __declspec(novtable) ExtraFavorite : public BSExtraData // 00
{
  public:
...
class __declspec(novtable) ExtraAliasInstanceArray : public BSExtraData // 00
{
  public:
...
class __declspec(novtable) ExtraLocation : public BSExtraData // 00
{
  public:
...
class __declspec(novtable) ExtraMaterialSwap : public BSExtraData // 00
{
  public:
...
class __declspec(novtable) ExtraTextDisplayData : public BSExtraData // 00
{
  public:
...
class __declspec(novtable) ExtraUniqueID : public BSExtraData // 00
{
  public:
...
class __declspec(novtable) ExtraPowerLinks : public BSExtraData // 00
{
  public:
