...
template <class T>
struct meets_length_req : std::disjunction<
...
template <class T>
struct meets_function_req : std::conjunction<
...
struct is_x64_pod<
    T,
    std::enable_if_t<
        std::is_union_v<T>>> : std::false_type
{
};
...
struct is_x64_pod<
    T,
    std::enable_if_t<
        std::is_class_v<T>>> : std::conjunction<meets_length_req<T>,
    ...
    requires(std::invocable<F, Args...>)
{
    ...
    {
        if constexpr (detail::is_x64_pod_v<std::invoke_result_t<F, Args...>>)
...
class Module
{
  public:
    ...
    [[nodiscard]] stl::zwstring filename() const noexcept
    {
        return _filename;
    }
...
class IDDatabase
{
  ...
  public:
    ...
    class Offset2ID
    {
      public:
        ...
        {
            return _offset2id.begin();
        }
        [[nodiscard]] const_iterator cbegin() const noexcept
        {
            return _offset2id.cbegin();
        }

        [[nodiscard]] const_iterator end() const noexcept
        {
            return _offset2id.end();
        }
        [[nodiscard]] const_iterator cend() const noexcept
        {
            return _offset2id.cend();
        }

        [[nodiscard]] const_reverse_iterator rbegin() const noexcept
        {
            return _offset2id.rbegin();
        }
        [[nodiscard]] const_reverse_iterator crbegin() const noexcept
        {
            return _offset2id.crbegin();
        }

        [[nodiscard]] const_reverse_iterator rend() const noexcept
        {
            return _offset2id.rend();
        }
        [[nodiscard]] const_reverse_iterator crend() const noexcept
        {
            return _offset2id.crend();
        }

        [[nodiscard]] size_type size() const noexcept
        {
            return _offset2id.size();
        }
  ...
  protected:
    ...
    [[nodiscard]] std::span<const mapping_t> get_id2offset() const noexcept
    {
        return _id2offset;
    }
