...
class VTable
{
  public:
    ...
    [[nodiscard]] reference operator[](std::size_t a_idx) noexcept
    {
        return _vtables[a_idx];
    }
    [[nodiscard]] const_reference operator[](std::size_t a_idx) const noexcept
    {
        return _vtables[a_idx];
    }
    ...
    {
        return _vtables.cend();
    }

    [[nodiscard]] size_type size() const noexcept
    {
        return _vtables.size();
    }
