...
class bhkPhysicsSystem : public NiObject
{
  public:
...
struct CompoundShapeData
{
    ...
    hkVector4f scale;
    hknpShape *shape;
    uint8_t pad[0x80 - 0x58];
};
static_assert(sizeof(CompoundShapeData) == 0x80);
...
class hknpCollisionQueryDispatcherBase
{
  public:
    ...
    static const ShapeMask defaultShapeMask = 0 | 1 << hknpCollisionQueryDispatcherBase::CONVEX | 1 << hknpCollisionQueryDispatcherBase::COMPRESSED_MESH | 1 << hknpCollisionQueryDispatcherBase::STATIC_COMPOUND | 1 << hknpCollisionQueryDispatcherBase::DYNAMIC_COMPOUND /* 1 << hknpCollisionQueryDispatcherBase::HEIGHT_FIELD*/
                                              | 1 << hknpCollisionQueryDispatcherBase::MASKED_COMPOSITE | 1 << hknpCollisionQueryDispatcherBase::SCALED_CONVEX /*| 1 << hknpCollisionQueryDispatcherBase::USER*/;
